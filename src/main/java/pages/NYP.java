...
public class NYP extends BaseTest {
   ...
   // }
	...
	@AndroidFindBy(xpath = "//android.widget.Button[contains(@resource-id,'welcome_continue')]")
	static	MobileElement WelcomeContinue;
	
	@AndroidFindBy(xpath = "//android.widget.Button[@resource-id='br.com.golmobile.nypost.dev:id/continue_customize']")
	static	MobileElement continueCustomize;	
	
	@AndroidFindBy(xpath = "//android.widget.Button[@resource-id='br.com.golmobile.nypost.dev:id/getting_around_continue']")
	static	MobileElement gettingAround;		
  ...
  //  }    
    ...
    public static void pressContinueButton () {
    	 ...
    	 //hideKeyboardIfVisible();
    		...
    		click(continueCustomize, "Customize page Continue button clicked");
    		click(gettingAround, "Getting around page Continue button clicked");
    		try {
    		scrollToElement();
    		}catch (Exception e) {
